...
var WikitudePlugin = function() {
    ...
    /**
     * To control the rotation behaviour of the underlaying SDK, a bitmask is defined so that certain interface orientations can be disabled.
     * The default rotation mask will allow orientation changes to all four interface orientations (the possible interface orientations are defined below).
     * To disable landscape rotations, the `this._iOSRotationMask` would look like the following: this._iOSRotationMask = iOSInterfaceOrientationPortrait;
     */
    var iOSInterfaceOrientationPortrait = 1;
    var iOSInterfaceOrientationPortraitUpsideDown = 2
    var iOSInterfaceOrientationLandscapeLeft = 4;
    var iOSInterfaceOrientationLandscapeRight = 8;
    this._iOSRotationMask = iOSInterfaceOrientationPortrait | iOSInterfaceOrientationPortraitUpsideDown | iOSInterfaceOrientationLandscapeLeft | iOSInterfaceOrientationLandscapeRight;
...
WikitudePlugin.prototype.loadARchitectWorld = function(worldPath) {
    ...
    if (this._isDeviceSupported) {
        ...
        cordova.exec(this.worldLaunched, this.worldFailedLaunching, "WikitudePlugin", "open", [{
            "SDK_Key": this._sdkKey,
            "ARchitectWorldPath": worldPath,
            "Options": {
                "iOS": {
                    "AugmentedRealityMode": this._arMode,
                    "RotationMask": this._iOSRotationMask
                },
                "Android": null
            }
        }]);
