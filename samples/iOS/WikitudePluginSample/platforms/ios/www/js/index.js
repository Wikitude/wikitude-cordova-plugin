...
var app = {
    ...
    loadARchitectWorld: function(sample) {
        ...
        if (app.isDeviceSupported) {
            ...
            if (sample == 1) {
                WikitudePlugin.loadARchitectWorld("www/world/4_ObtainPoiData_1_FromWebservice/index.html");
            } else {
                WikitudePlugin.loadARchitectWorld("www/world/1_ImageRecognition_1_ImageOnTarget/index.html");
            }
