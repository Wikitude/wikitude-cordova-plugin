// sample code of jquery mobile UI slider, solely added "World.onSliderChanged(this._value());"
(function($, undefined) {
    $.widget("mobile.slider", $.mobile.slider, {
        ...
        refresh: function() {
            ...
            // IMPORTANT: notify World abour slider changes
            World.onSliderChanged(this._value());
